...
const BuilderArea = (props) => {
    ...
    return (
        <>
            {loading && <PropagateLoader id='spinner' color="#2945FF" size={30} />}
            ...
            <div className="d-flex flex-wrap justify-content-center">
                <Button className='mx-2 my-5' colorScheme={'#2945FF'} variant={'outline'} onClick={handlePrint}>Print</Button>
                <Button className='mx-2 my-5' colorScheme={'#2945FF'} variant={'outline'} onClick={handleSelectNewTemplate}>Select Another Template</Button>
            </div>
            <Footer />
        </>
    )
